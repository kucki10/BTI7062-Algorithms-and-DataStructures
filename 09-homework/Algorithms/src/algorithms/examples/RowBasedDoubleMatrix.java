...
public class RowBasedDoubleMatrix implements Matrix<Double> {
    private Double[][] matrix;

    public RowBasedDoubleMatrix(int columnNumber, int rowNumber) {
    ...
    public Matrix<Double> multiply(Matrix<Double> matrix) {
        ...
        Matrix<Double> resultMatrix = new RowBasedDoubleMatrix(this.getHeight(), matrix.getWidth());
