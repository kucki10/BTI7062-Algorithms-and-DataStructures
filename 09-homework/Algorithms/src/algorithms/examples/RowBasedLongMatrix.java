...
public class RowBasedLongMatrix implements Matrix<Long> {
    private Long[][] matrix;

    public RowBasedLongMatrix(int columnNumber, int rowNumber) {
        this.matrix = new Long[rowNumber][columnNumber];
    ...
    public Matrix<Long> multiply(Matrix<Long> matrix) {
        ...
        Matrix<Long> resultMatrix = new RowBasedLongMatrix(this.getHeight(), matrix.getWidth());
